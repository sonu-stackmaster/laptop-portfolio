...
import { Sliders, Sun, Moon, Volume2, VolumeX, Smartphone, Cpu, ShieldCheck } from 'lucide-react';
import { soundFx } from '../../utils/audio';

export default function SettingsMobileApp({ isDark, onToggleTheme, isMuted, onToggleSound }) {
  return (
