...
import { Sliders, Sun, Moon, Volume2, VolumeX, Tablet, Cpu } from 'lucide-react';
import { soundFx } from '../../utils/audio';

export default function SettingsiPadCard({ isDark, onToggleTheme, isMuted, onToggleSound }) {
  return (
